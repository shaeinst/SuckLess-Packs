...
static char selbordercolor[]        = "#1B7D60";
static char selbgcolor[]            = "#1B7D60";
...
static Key keys[] = {
	...
	/********************************************************************************/
	// 		tiling/window/workspace related
	/********************************************************************************/  
	// tiling types
	...
	// increase/decrease master window
	{ MODKEY,				XK_m,		incnmaster,     {.i = +1 } },
	{ MODKEY|ShiftMask,		XK_m,		incnmaster,     {.i = -1 } },

	// increase/decrease gaps between windows(opened windows/apps)
	{ MODKEY,				XK_z,		incrgaps,		{.i = +1 } },
	{ MODKEY|ShiftMask,		XK_z,		incrgaps,		{.i = -1 } },

	// increase/decrease windows/(opened pass) width
	...
	// toggle/cycle through workspace
	{ Mod1Mask,			XK_Tab,		shiftview,		{ .i = +1 } },
	{ Mod1Mask|MODKEY,XK_Tab,		shiftview,		{ .i = -1 } },
	/* { MODKEY|ShiftMask,	XK_g,		spawn,		SHCMD("") }, */

	// toggle remove window gap
	...
	/********************************************************************************/
	// 		end of tiling/window/workspace related
	/********************************************************************************/  
	...
	{ MODKEY|ControlMask,			XK_x,	spawn,	SHCMD("[ \"$(printf \"No\\nYes\" | dmenu -i -nb darkred -sb red -sf white -nf gray -p \"Logout computer?\")\" = Yes ] && pkill -KILL -u $(who | awk '{ print $1 }')") },
	{ MODKEY|ControlMask|ShiftMask,	XK_x,	spawn,	SHCMD("[ \"$(printf \"No\\nYes\" | dmenu -i -nb darkred -sb red -sf white -nf gray -p \"Reboot computer?\")\" = Yes ] && sudo -A reboot -h now") },
	...
	// toggle between recent and current workspace
	...
	{ MODKEY|ShiftMask,	XK_v,		spawn,		SHCMD("{ killall xcompmgr || setsid xcompmgr & } ; xwallpaper --zoom ~/.config/Wallpaper/wall.jpg") },
	...
	// screenshoot
	{ 0,				XK_Print,	spawn,		SHCMD("flameshot gui -p /home/lazy/Pictures/ScreenShots/flameShot/") },
	{ ShiftMask,		XK_Print,	spawn,		SHCMD("flameshot full -p /home/lazy/Pictures/ScreenShots/flameShot/") },
	...
	// { 0,				XK_Print,	spawn,		SHCMD("maim screenshot_taken_on-$(date '+(%d-%m-%Y)(%H:%M:%S)').png") },
	// 
	// 
	// 
	// 
